...
const greeting = {
  ...
  subTitle: emoji(
    "Passionate about Computers  , Cricket , Sport Cars , Technology"
  ),
  resumeLink:
    "https://drive.google.com/file/d/1rdzbqvPj2ux6pWCsq6-jhimtSi_WDKrW/view?usp=sharing", // Set to empty to hide the button
...
const skillsSection = {
  title: "What I do",
  subTitle: "Passionate Cs Grad who still beleives in Aliens",
  skills: [
    emoji(
  ...
  schools: [
    {
      ...
      descBullets: [
        "coursework",
        "Artificial Intelligence (CS 527), Algorithms(CS 561), Data-Mining(CS 521), Cloud Computing(ECE 530), Computer Networks (CS 585), Database Management Systems(CS 564), Software Foundations(CS 558), Software Specification (CS 580), Machine Learning(CS 529), Advanced Machine Learning(CS 591) "
      ]
    },
    {
  ...
  experience: [
    {
      ...
      desc: "Full stack web applicaiton that saves atleast an hour a day for process engineer, process readiness indicator , managing production applications",
      descBullets: [
